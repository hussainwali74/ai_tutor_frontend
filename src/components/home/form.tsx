...
export function HomeFormComponent({
  ...
  return (
    <div className="lg:w-full">
      <div className=" lg:w-[76%] flex-none py-2 px-2 lg:p-6">
        <div className="flex bg-white border border-red-100 rounded">
          <input
            disabled={disabled}
            type="text"
          ...
          {audioLessonEnabled ? (
            <MicrophoneComponent
              ...
              className={"rounded-lg px-1 h-8 mt-[0.35rem] mr-2  bg-blue-100 text-black"}
            />
          ) : (
            <button
              disabled={disabled}
